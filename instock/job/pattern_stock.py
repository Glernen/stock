...
def save_to_database(df):
    ...
    # 生成批量SQL
    sql_batches = sql_batch_generator('pattern_stock', filtered_df, 6000)
...
def main():
    ...
    print(f"识别到 {bullish_count} 只股票出现阳锤子线形态")
    print(f"识别到 {bearish_count} 只股票出现阴锤子线形态")
